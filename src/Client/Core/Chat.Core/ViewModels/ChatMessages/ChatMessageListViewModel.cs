...
namespace Chat.Core
{
    public class ChatMessageListViewModel : BaseViewModel
    {
        ...
        {
            // Create commands
            AttachmentButtonCommand = new DelegateCommand(AttachmentButton);
            PopupClickawayCommand = new DelegateCommand(PopupClickaway);
            ...
            FilteredItems = new ObservableCollection<ChatMessageListItemViewModel>()
            {
                ...
                new ChatMessageListItemViewModel
                {
                    ...
                    Initials = "PL",
                    Message = "The new server is up. Go to 192.168.1.1.\r\nUsername is admin, password is P8ssw0rd!" +
                              "The new server is up. Go to 192.168.1.1.\r\nUsername is admin, password is P8ssw0rd!" +
                              "The new server is up. Go to 192.168.1.1.\r\nUsername is admin, password is P8ssw0rd!" +
                              "The new server is up. Go to 192.168.1.1.\r\nUsername is admin, password is P8ssw0rd!The new server is up. Go to 192.168.1.1.\r\nUsername is admin, password is P8ssw0rd!",
                    ProfilePictureRGB = "3099c5",
                    MessageSentTime = DateTimeOffset.UtcNow,
                    SentByMe = true,
                },
